...
4. **Step 4: 地圖可視化繪製 (Folium Mapping)**
   * 建構互動式地圖，整合 HeatMap (降雨熱區)、雨量站點（半徑隨雨量動態變化）與避難所標記。
5. **Step 5: AI 戰術顧問與最終輸出 (AI Tactical Advisor)**
